...
The first dataset, `sc.csv` has some scRNAseq data from the package `scRNAseq`. We'll use some (real) data from 20 samples. Read in the file and apply `head` and `dim`.
