...
(Note that you can also use command-line tools for querying LDlink - see [https://ldlink.nih.gov/apiaccess](https://ldlink.nih.gov/apiaccess)).
...
Register here [https://ldlink.nih.gov/apiaccess](https://ldlink.nih.gov/apiaccess) with your name, email address, and institution; use a REAL email address. You will be emailed an access token. Copy and paste it below.
...
# Read them in
# View them
lead_snps_path <- "https://jmc108.github.io/hugen2073-textbook/exercises/17_linkage_disequilibrium/lead_snps.txt"
...
# Set the path
# Write out the list
proxies_out_file <- "/Users/jonathanchernus/Desktop/top_hits_proxies.txt" # Set the path to the file!
